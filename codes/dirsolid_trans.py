...
from math import pi
import numpy as np
from ds_input_scn1 import phy_parameter, simu_parameter
...
def initial(): # properties/parameters of interests
    ...
    psi0 = -sqrt2* ( zz-z0-mag*np.cos(2*pi/lx*xx*nw) )
    U0 = 0*psi0 - 1
...
y = np.vstack((np.reshape(psi0,(nv,1)), np.reshape(U0,(nv,1)) )) #T0/y0
