...
def solve_sparse(A, b, P):
      ...
      x,status=la.cg(A, b,tol=1e-7, M=P, maxiter = 300, callback=callback)
...
for ii in range(Mt):
    ...
    ynew,stat,num_iter = solve_sparse(A, Q@b, M)
...
traj_filename = 'macro_output_higherV.mat'
