...
# NOTE: for numbers entered here, if having units: length in micron, time in second, temperature in K.
    ...
    return f32(delta), f32(k), f32(lamd), f32(R_tilde), f32(Dl_tilde), f32(lT_tilde), f32(W0), f32(tau0)
...
def simu_para(W0,Dl_tilde):
    ...
    return f32(eps), f32(alpha0), f32(lxd), f32(aratio), nx, f32(dt), Mt, f32(eta), filename
...
def planar_initial(lx,zz):
    ...
    z0 = lx*0.1                   # initial location of interface in W0   
    psi0 = z0 - zz
