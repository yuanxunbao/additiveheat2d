...
where 
\begin{align}
U = \frac{1}{1-k} \left( \frac{ c/c_l^0}{(1-\phi)/2 + k(1+\phi)/2} \right), \quad d(\phi) = (1-\phi)/2 .
\end{align}
...
The initial condition for $U$ is $U(c_l^0, \phi_0)$ or $U(c_{\infty},\phi_0)$. 
\yxb{I don't know which one is the correct one, will ask Steve.}
